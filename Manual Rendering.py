...
# 'graphics.py' graphics library has been used in this program.
# 'python-chess' library has been used  in this program. https://python-chess.readthedocs.io/en/latest/
# The images for chess pieces were hand drawn on Sketchbook Application.
# These images were edited to have a transparent at ImageResizer.com; https://imageresizer.com/transparent-background
# Then the images were resized at ImageResizer.com; https://imageresizer.com/
# The images were converted to '.gif' format at CloudConvert; https://cloudconvert.com/png-to-gif